        ...
        <div class="modal-content">
          ...
          <hr>
            <div id="add_class_form">
              ...
              <input class="form-control" name="code" placeholder="Code ,Eg- 16IS64 CASE SENSITIVE">
              ...
              <input class="form-control" name="start" placeholder="Starting Roll Number (Eg. 1RV17IS001 CASE SENSITIVE)">
              <input class="form-control" name="end" placeholder="Ending Roll Number (Eg. 1RV17IS060 CASE SENSITIVE)">
